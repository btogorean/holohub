...
class AdvNetworkingDefaultRxOp : public Operator {
 public:
  ...
  void initialize() override {
    ...
    HOLOSCAN_LOG_INFO("AdvNetworkingDefaultRxOp::initialize()");
    ...
    HOLOSCAN_LOG_INFO("AdvNetworkingDefaultRxOp::initialize() complete");
  }

  void freeResources() {
    HOLOSCAN_LOG_INFO("AdvNetworkingDefaultRxOp::freeResources() start");
    for (int n = 0; n < num_concurrent; n++) {
    ...
    HOLOSCAN_LOG_INFO("AdvNetworkingDefaultRxOp::freeResources() complete");
  }
